...
const BUILD = '2026.07.23-f5182e1';         // GLEICHE Zeichenkette wie window.__BUILD.id in index.html (Delivery-Stempel)
const CACHE = 'kommilo-v' + BUILD;          // Cache-Name direkt aus dem Build-Stempel abgeleitet → kommilo-v2026.07.23-f5182e1
