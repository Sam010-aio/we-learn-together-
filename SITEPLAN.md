...
| Altgebäude | (+4, −96) U-Block | Prachtfront OSTEN an der Pockelsstraße | Owner: N-S-Prachtflügel an der Straße + Nordflügel (0,7×) + kurzer Südflügel (0,3×) am kleinen Parkplatz → 3 unterschiedlich lange Seiten (nicht identisch). Kein Neubau: Geometrie geteilt |
...
| Schleinitzstraße | Z≈−160, X −70…−10 | E-W | neu gezeichnet |
| Oker (Ost-West) | X −130…+70 @ Z≈−195 | quer durch die Nordwiese, nördlich hinter allen Gebäuden | Owner: von N-S auf O-W umgebaut; Boden mit E-W-Fluss-Loch; Wasser-Reflektor + Böschungen entlang X gesweept |
| Straßenbrücke | (+20, −195) | quert die E-W-Oker N-S (am Ende des Nordwegs) | breite Betonbrücke 90° gedreht; kleine Brücke/Steg ausgeblendet |
